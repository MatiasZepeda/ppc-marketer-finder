export const US_CITIES = [
  ...
  "Chandler, AZ", "Charlotte, NC", "Chesapeake, VA", "Chicago, IL",
  "Chula Vista, CA", "Cincinnati, OH", "Cleveland, OH", "Colorado Springs, CO",
  ...
  "Gilbert, AZ", "Glendale, AZ", "Glendale, CA", "Greensboro, NC",
  "Henderson, NV", "Hialeah, FL", "Honolulu, HI", "Houston, TX",
  "Indianapolis, IN", "Irvine, CA", "Irving, TX", "Jacksonville, FL",
  "Jersey City, NJ", "Kansas City, MO", "Laredo, TX", "Las Vegas, NV",
  "Lexington, KY", "Lincoln, NE", "Long Beach, CA", "Los Angeles, CA",
  ...
  "Norfolk, VA", "North Las Vegas, NV", "Oakland, CA", "Oklahoma City, OK",
  "Omaha, NE", "Orlando, FL", "Philadelphia, PA", "Phoenix, AZ",
  "Pittsburgh, PA", "Plano, TX", "Portland, OR", "Raleigh, NC",
  "Reno, NV", "Richmond, VA", "Riverside, CA", "Sacramento, CA",
  "San Antonio, TX", "San Diego, CA", "San Francisco, CA", "San Jose, CA",
  "Santa Ana, CA", "Scottsdale, AZ", "Seattle, WA", "St. Louis, MO",
  "St. Paul, MN", "Stockton, CA", "Tampa, FL", "Toledo, OH",
